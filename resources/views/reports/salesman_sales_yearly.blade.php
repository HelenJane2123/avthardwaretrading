            ...
            <div class="card-header bg-white">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <small class="text-muted">Use the filters below to narrow yearly salesman sales results.</small>
                    </div>
                    <a href="{{ route('reports.salesman_sales_yearly') }}" class="btn btn-sm btn-outline-secondary">
