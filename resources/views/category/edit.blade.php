    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                ...
                <p class="text-muted">Update the details of an existing category to keep your items organized.</p>
            </div>
                    ...
                    <div class="tile-body">
                        <form class="row" method="POST" action="{{route('category.update', $category->id)}}">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input name="name" value="{{ $category->name }}" class="form-control form-control-sm @error('name') is-invalid @enderror" type="text" placeholder="Enter your name">
                                @error('name')
