    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                ...
                <p class="text-muted">Update the details of an existing unit to keep your inventory organized.</p>
            </div>
                    ...
                    <div class="tile-body">
                        <form class="row" method="POST" action="{{route('unit.update', $unit->id)}}">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input name="name" value="{{ $unit->name }}" class="form-control form-control-sm @error('name') is-invalid @enderror" type="text" placeholder="Enter unit">
                                @error('name')
