...
@section('content')
    ...
    <main class="app-content">
        ...
        <div class="">
            <a class="btn btn-sm btn-outline-primary" href="{{route('tax.index')}}"><i class="fa fa-cogs"></i> Manage Tax</a>
        </div>
        <div class="row mt-2">
                    ...
                    <div class="tile-body">
                        <form method="POST" action="{{route('tax.store')}}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="name" class="form-control form-control-sm @error('name') is-invalid @enderror" type="text" placeholder="Enter Tax Amount">
                                @error('name')
                            ...
                            <div class="form-group col-md-4 align-self-end">
                                <button class="btn btn-sm btn-success" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add Now</button>
                            </div>
                        </form>
                    </div>
                </div>
